...
int main()
{
	...
	// WSAEventSelect 모델 = (WSAEventSelect 함수가 핵심)
	...
	// - 따라서 clienㅌtSocket은 FD_READ, FD_WRITE 등을 다시 등록 필요
	// 드물게 WASEWOULDBLOCK 오류가 뜰 수 있으니 예외 처리 필요
	// 중요)
	...
	// 1) socket
	// 2) eventObkect : socket과 연동된 이벤트 객체 핸들을 넘겨주면 이벤트 객체를 non-signaled
